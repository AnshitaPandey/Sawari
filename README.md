[readme.md](https://github.com/user-attachments/files/23289705/readme.md)
...
- 🌐 **Frontend (Vercel):** [https://Sawari-git-main-anshita-pandeys-projects.vercel.app](https://uber-clone-git-main-kshithij-singhanias-projects.vercel.app)
...
```bash
git clone https://github.com/AnshitaPandey/Uber-Clone.git
cd Uber-Clone
```
...
**Anshita Pandey**
GitHub: [@Anshita Pandey](https://github.com/AnshitaPandey)
